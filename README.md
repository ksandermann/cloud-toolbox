...
## version history
latest -> 2020-08-07_01

project -> 2020-08-07_02


| RELEASE       | UBUNTU | DOCKER   | KUBECTL  | OC CLI | HELM   | HELM3   | TERRAFORM | TERRAFORM11   | AWS CLI  | AZ CLI | GCLOUD SDK | KOPS   | ANSIBLE | JINJA2 | OPENSSH |
|---------------|--------|----------|----------|--------|--------|---------|-----------|---------------|----------|--------|------------|--------|---------|--------|---------|
